    ...
    <body>
        ...
        <div id="cajacontenido">
            <div id="aplicacion">
                ...
                <div id="navegarsitio">
                    <a href="index1.php" title="Otro sitio">
                        Ir a la segunda página con su contador propio
                    </a>

                    <br /><br />

                    <a href="index2.php" title="Otro sitio">
                        Ir a la tercera página con su contador propio
                    </a>
                </div>
            </div>
        </div>
